...
import { BankAccountReport, CashBookReport, DeletePayment, DeleteReceipt, ExpensesTotal, OtpVerifyForReceipt, PartySendOtp, ProfitLossReport, SaveOtp, TaxReport, UpdatePayment, UpdateReceipt, ViewOtp, ViewReceiptById, ViewReceiptByPartyId, ViewReceiptBySalesPersonId, dashboardBalance, dashboardCashInHand, dashboardPayment, dashboardReceipt, gstPaymentDashboard, ledgerCheck, savePayment, savePaymentWithExcel, saveReceipt, saveReceiptWithExcel, transactionCalculate, viewReceipt } from "../controller/receipt.controller.js";
...
router.get("/view-salesperson-receipt/:id/:database", ViewReceiptBySalesPersonId)
...
router.get("/expenses/:database",ExpensesTotal)
router.get("/dashboard-bankbalance/:database",dashboardBalance)
router.get("/dashboard-gstPayment/:database",gstPaymentDashboard)
router.get("/ledger-count/:id",ledgerCheck)
